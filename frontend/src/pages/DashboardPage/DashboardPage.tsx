...
const DashboardPage = () => {
  ...
  const [
    isConnectionRequestsModalVisible,
    setIsConnectionRequestsModalVisible,
  ...
  useEffect(() => {
    if (pageState === "tasks") {
      ...
      if (projectSortType === "Name") {
        sortedProjects = [...shownProjects].sort((projectA, projectB) =>
          projectA.title.localeCompare(projectB.title)
        );
      } else if (projectSortType === "Description") {
        sortedProjects = [...shownProjects].sort((projectA, projectB) =>
          projectA.description.localeCompare(projectB.description)
        );
      }
  ...
  return (
    <DashboardPageContainer>
      <ConnectionRequestsModal
        ...
        handleClose={() => {
          setIsConnectionRequestsModalVisible(false);
        }}
      ...
      <Header
        triggerConnectionRequestsModal={() =>
          setIsConnectionRequestsModalVisible(true)
        }
            ...
            <StyledForm>
              ...
              {pageState === "tasks" ? (
                ...
                <Select
                  ...
                  onChange={(e: SelectChangeEvent) =>
                    setProjectSortType(e.target.value)
                  }
                >
              ...
              shownTasks.length === 0 ? (
                ...
                <>
                  <TasksLabelContainer>
                    <p
                      style={{
                        color: taskSortType === "ID" ? "black" : Palette.thGray,
                      }}
                    >
                      ID
                    </p>
                    <p
                      style={{
                        color:
                          taskSortType === "Title" ? "black" : Palette.thGray,
                      }}
                    >
                      Title
                    </p>
                    ...
                    <p
                      style={{
                        color:
                          taskSortType === "Status" ? "black" : Palette.thGray,
                      }}
                    >
                      Status
                    </p>
              ...
              <>
                <ProjectsLabelContainer>
                  <p
                    style={{
                      color:
                        projectSortType === "Name" ? "black" : Palette.thGray,
                    }}
                  >
                    Name
                  </p>
