...
const ProfilePage = () => {
  ...
  const [updatedProfileDetails, setUpdatedProfileDetails] =
    useState<IUpdatedProfileDetails>(EmptyUpdatedProfileDetails);
  ...
  const updateLogo = async (e: ChangeEvent) => {
    ...
    setUpdatedProfileDetails({
      ...
      profilePicture: convertedFile as string,
    });
  };
        ...
        <ProfilePageContainer>
          ...
          <TopTopContainer>
            <TopContainer borderColor={getBorderColor()}>
              {pageState === "view" ? (
                ...
                <StyledLabel>
                  {!!updatedProfileDetails.profilePicture ? (
                    <img
                      src={updatedProfileDetails.profilePicture}
                      alt="user avatar"
                    />
                  ) : profileDetails.profilePicture ? (
                    <img
            ...
            <StatsContainer>
              <BusynessContainer>
                <Box>
                  <p style={{ color: Palette.thGray }}>
                    {`Busyness (${
                      Math.round(profileDetails.busyness) > 100
                        ? "100%+"
                        : Math.round(profileDetails.busyness)
                    })`}
                  </p>
                </Box>
                <BusynessWrapper>
              ...
              <p>
                {`Current points: ${
                  profileDetails.points === null ? "0" : profileDetails.points
                }`}
              </p>
            </StatsContainer>
          </TopTopContainer>
