...
const TaskPage = () => {
  ...
  const loadTask = async () => {
    try {
      ...
      if (
        resp.profileAuthor.id === profileId ||
        resp.profileAssignee.id === profileId
      )
        setIsMember(true);
  ...
  const updateTask = async () => {
    ...
    if (
      ...
      updatedTaskDetails.deadline === "" &&
      status === taskDetails.status &&
      points === taskDetails.points &&
      selectedMember.id === taskDetails.profileAssignee.id &&
      updatedTaskDetails.description === ""
    ) {
      setPageState("view");
      return;
    }
    ...
    updatedTaskDetails.title =
      updatedTaskDetails.title !== ""
        ? updatedTaskDetails.title
        : taskDetails.title;
    updatedTaskDetails.deadline = !!updatedTaskDetails.deadline
      ? updatedTaskDetails.deadline
      : taskDetails.deadline;
    updatedTaskDetails.description = !!updatedTaskDetails.description
      ? updatedTaskDetails.description
      : taskDetails.description;
    updatedTaskDetails.points =
      points !== taskDetails.points ? taskDetails.points : points;
    updatedTaskDetails.status =
      updatedTaskDetails.status !== taskDetails.status
        ? updatedTaskDetails.status
        : taskDetails.status;
      ...
      {isLoading ? (
        ...
        <TaskPageContainer>
          <DeleteOverlay
            ...
            memberId={null}
            secondaryContentId={parseInt(projectId!)}
          />
          <Header />
          <BodyContainer>
            <FriendsList />
                ...
                {pageState === "view" ? (
                  <>
                    <TitleContainerView>
                      ...
                      <h1>
                        &nbsp;| {taskDetails.title} [{taskDetails.points}{" "}
                        points]
                      </h1>
                      {isMember ? (
                        <IconContainerView>
                  ...
                  <TopContainer>
                    <TitleContainerEdit>
                      ...
                      <IconContainerEdit>
                        ...
                        <UpdateButton variant="contained" onClick={updateTask}>
                          Update
                        </UpdateButton>
                      </IconContainerEdit>
                    </TitleContainerEdit>
                ...
                {isMember ? (
                  ...
                  >
                    <MenuItem value={"0"} key={"0"}>
                      <p
                        style={{
                          backgroundColor: fetchStatusColor(0),
                          color: "white",
                          borderRadius: "1rem",
                          textAlign: "center",
                          width: "13vw",
                    ...
                    <MenuItem value={"1"} key={"1"}>
                      <p
                        style={{
                          backgroundColor: fetchStatusColor(1),
                          color: "white",
                          borderRadius: "1rem",
                          textAlign: "center",
                          width: "13vw",
                    ...
                    <MenuItem value={"2"} key={"2"}>
                      <p
                        style={{
                          backgroundColor: fetchStatusColor(2),
                          color: "white",
                          borderRadius: "1rem",
                          textAlign: "center",
                          width: "13vw",
                    ...
                    <MenuItem value={"3"} key={"3"}>
                      <p
                        style={{
                          backgroundColor: fetchStatusColor(3),
                          color: "white",
                          borderRadius: "1rem",
                          textAlign: "center",
                          width: "13vw",
                  ...
                  <p
                    style={{
                      backgroundColor: fetchStatusColor(taskDetails.status),
                      color: "white",
                      borderRadius: "1rem",
                      textAlign: "center",
                      width: "10rem",
                ...
                <TaskMembers>
                  <h3>
                    ...
                    {!!taskDetails.profileAuthor.profilePicture ? (
                      <UserAvatar
                        src={taskDetails.profileAuthor.profilePicture}
                        alt="author avatar"
                      />
                    ) : (
                      <StyledAvatar>
                    ...
                    {pageState === "view" ? (
                      <>
                        {!!taskDetails.profileAssignee.profilePicture ? (
                          <UserAvatar
                            src={taskDetails.profileAssignee.profilePicture}
                            alt="assignee avatar"
                          />
                        ) : (
                          <StyledAvatar>
                      ...
                      <Select
                        value={
                          selectedMember === null || selectedMember.id === -1
                            ? ""
                            : selectedMember.id.toString()
                        }
                        onChange={(e: SelectChangeEvent) =>
                          changeMember(parseInt(e.target.value))
                        }
                        sx={{ width: "30%" }}
